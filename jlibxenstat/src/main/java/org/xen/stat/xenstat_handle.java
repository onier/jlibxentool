...
import org.xen.stat.XenstatLibrary.xc_interface;
import org.xen.stat.XenstatLibrary.xs_handle;
 ...
 */
public class xenstat_handle extends Structure {
    ...
    public static class ByReference extends xenstat_handle implements Structure.ByReference {

    };

    public static class ByValue extends xenstat_handle implements Structure.ByValue {
